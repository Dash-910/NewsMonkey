...
import {BrowserRouter as Router,Switch,Routes,Link} from "rect-router-dom"
  ...
  return (
    <div>
      <Router>
        ...
        <Route exact path="/entertainment" element={<News key="health" pageSize={5} country="in" category="health"/>}/>
